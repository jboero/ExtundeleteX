...
struct transaction_s {
  ...
  /* Doubly-linked circular list of all inodes owned by this transaction */
  /* AKPM: unused */
  ...
  /* Doubly-linked circular list of all buffers reserved but not yet modified
   * by this transaction */
   ...
   */
  /* Protected by journal_datalist_lock */
  struct journal_head *1_checkpoint_list;

  /* Doubly-linked circular list of temporary buffers currently
           undergoing IO in the log */
  struct journal_head *1_iobuf_list;

  /* Doubly-linked circular list of metadata buffers being
           shadowed by log IO. The IO buffers on the iobuf list and the
           shadow buffers on this list match each other one for one at
           all times. */
  struct journal_head *1_shadow_list;

  /* Doubly-linked circular list of control buffers being written
           to the log. */
  struct journal_head *1_log_list;
...
struct journal_s {
  ...
  struct buffer_head *1_sb_buffer;
  journal_superblock_t *1_superblock;
  ...
  struct timer_list *1_commit_timer;
